...
namespace Bookstore.DataAccess.Migrations
{
    ...
    [Migration("20230607200846_priceCartOrderEdit2")]
    partial class priceCartOrderEdit2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookstore.Domain.Entities.BookDiscount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bookstore.Domain.Entities.LogEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bookstore.Domain.Entities.RoleUseCase", b =>
                {
            ...
            modelBuilder.Entity("Bookstore.Domain.Entities.BookDiscount", b =>
                {
                    b.HasOne("Bookstore.Domain.Entities.BookPublisher", "BookPublisher")
                        .WithMany("Discounts")
            ...
            modelBuilder.Entity("Bookstore.Domain.Entities.File", b =>
                {
                    b.HasOne("Bookstore.Domain.Entities.BookPublisher", "BookPublisher")
                        .WithOne("Image")
                        .HasForeignKey("Bookstore.Domain.Entities.File", "BookPublisherId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
